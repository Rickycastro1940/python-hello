...
Brasa Points is Brasaland's loyalty program. For every 10,000 COP (or 10 USD
in Florida) spent, the customer earns 1 point. Points don't expire as long
as the account remains active (at least one purchase every 12 months).

Program tiers:
- Bronze (0-19 points): 5% off drinks on Tuesdays.
- Silver (20-49 points): 10% off the main dish, once a month.
- Gold (50+ points): 15% permanent discount and early access to the seasonal
  menu before the general public.

Points can be redeemed starting at 15 accumulated points, in increments of
...
- "What happens if I move to another country?" Points are valid at any
  Brasaland location, in both Colombia and Florida, at the day's exchange
  rate.
